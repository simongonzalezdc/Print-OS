...
const createMockStore = (overrides: Partial<SceneStore> = {}): SceneStore => ({
  ...
  setPendingBusinessAnalysis: vi.fn(),
  setPendingDesignPrompt: vi.fn(),
  ...overrides,
});

describe('Caedo 3D - End-to-End Integration', () => {
  ...
  describe('Complete User Workflow', () => {
    it('should allow creating a project and adding objects', async () => {
      ...
      expect(screen.getByText('AI_DESIGN_CORE')).toBeInTheDocument();

      // Test AI input
      const input = screen.getByPlaceholderText('Structure my design...');
