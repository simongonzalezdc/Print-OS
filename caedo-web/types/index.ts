import type { PrinterProfile } from '@/lib/constants/printer-profiles';
  ...
  // =============================================================================
// Caedo 3D - Core Type Definitions
// =============================================================================
...
export interface SceneStore {
  ...
  setPendingBusinessAnalysis: (data: { stlBlob: Blob | null; objects: SceneObject[]; totalGrams: number } | null) => void;
  setPendingDesignPrompt: (prompt: string | null) => void;
}
