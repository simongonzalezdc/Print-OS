# Caedo 3D - Design for Manufacturing (DFM) Knowledge Base
...
## 8. Footwear Design Rules (TPU 90A)

### 8.1 Functional Dimensions

| Feature | Minimum | Recommended |
|---------|---------|-------------|
| **Sole Thickness** | 8.0mm | 12.0mm |
| **Strap Width** | 15.0mm | 20.0mm |
| **Strap Thickness** | 3.0mm | 4.0mm |
| **Edge Radius** | 3.0mm | 5.0mm |
| **Lattice Wall** | 1.2mm | 1.6mm |

### 8.2 Material Preparation & Printing

> [!IMPORTANT]
> **Filament Drying**: TPU 90A must be dried at 65°C for 8+ hours. Moisture causes bubbling and poor layer adhesion.

- **Storage**: Maintain <20% RH during printing.
- **Speed**: Cap at 40-60 mm/s.
- **Retraction**: Minimize to prevent clogging.
- **Nozzle**: 0.6mm hardened steel preferred for reliability.

### 8.3 Layer Orientation

- **Soles**: Print flat on build plate.
- **Strength**: Layers MUST be perpendicular to the main flexing axis.
- **Supports**: Angle uppers/straps at 45° to minimize internal supports that are hard to remove from flexible parts.
