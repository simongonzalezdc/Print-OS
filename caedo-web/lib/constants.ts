// =============================================================================
// Caedo 3D - Application Constants
// =============================================================================
...
export const APP_NAME = 'Caedo 3D';
...
export const AI = {
  // Default provider: Always ZAI (GLM-4.7)
  DEFAULT_PROVIDER: AI_PROVIDERS.ZAI,

  // Model defaults: Only GLM-4.7
  DEFAULT_MODELS: {
    zai: 'glm-4.7',
  },
...
export const STORAGE_KEYS = {
  // Project data
  PROJECTS: 'caedo-projects',
  CURRENT_PROJECT: 'caedo-current-project',

  // Auto-save
  AUTOSAVE_PREFIX: 'caedo-autosave-',

  // User preferences
  PREFERENCES: 'caedo-preferences',

  // AI conversation history
  AI_HISTORY: 'caedo-ai-history',
} as const;
