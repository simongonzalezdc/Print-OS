...
export const FASTENERS = {
  SCREWS: {
    M2: { headDiameter: 3.8, headHeight: 1.3, shaftDiameter: 2.0, pitch: 0.4 },
    M2_5: { headDiameter: 4.5, headHeight: 1.7, shaftDiameter: 2.5, pitch: 0.45 },
    M3: { headDiameter: 5.5, headHeight: 2.0, shaftDiameter: 3.0, pitch: 0.5 },
    M4: { headDiameter: 7.0, headHeight: 2.6, shaftDiameter: 4.0, pitch: 0.7 },
    M5: { headDiameter: 8.5, headHeight: 3.3, shaftDiameter: 5.0, pitch: 0.8 },
  },
  
  HEAT_SET_INSERTS: {
    M2: { holeDiameter: 3.2, depth: 3.0 },
    M3: { holeDiameter: 4.0, depth: 4.0 },
    M4: { holeDiameter: 5.6, depth: 5.7 },
    M5: { holeDiameter: 6.4, depth: 6.4 },
  },
} as const;
...
export const BATTERIES = {
  AA: { diameter: 14.5, length: 50.5, nominalVoltage: 1.5 },
  AAA: { diameter: 10.5, length: 44.5, nominalVoltage: 1.5 },
  '18650': { diameter: 18.6, length: 65.2, nominalVoltage: 3.7 },
  '21700': { diameter: 21.1, length: 70.1, nominalVoltage: 3.7 },
  CR2032: { diameter: 20.0, height: 3.2, nominalVoltage: 3.0 },
} as const;
...
export type FastenerType = keyof typeof FASTENERS.SCREWS;
export type BatteryType = keyof typeof BATTERIES;
