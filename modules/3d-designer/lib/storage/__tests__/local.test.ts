...
describe('Local Storage', () => {
  ...
  describe('Project Management', () => {
    ...
    it('should save projects correctly', async () => {
      ...
      expect(mockSet).toHaveBeenCalledWith(
        'voiceforge-projects_test-project-id',
        mockProject
      );
    });
    ...
    it('should load projects correctly', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('voiceforge-projects_test-project-id');
    ...
    it('should list projects correctly', async () => {
      const mockKeyList = ['voiceforge-projects_1', 'voiceforge-projects_2', 'other-key'];
      const mockProjects = [mockProject, { ...mockProject, id: '2', name: 'Project 2' }];

      mockKeys.mockResolvedValue(mockKeyList);
      mockGet.mockImplementation((key: string) => {
        if (key === 'voiceforge-projects_1') return Promise.resolve(mockProjects[0]);
        if (key === 'voiceforge-projects_2') return Promise.resolve(mockProjects[1]);
    ...
    it('should delete projects correctly', async () => {
      ...
      expect(mockDel).toHaveBeenCalledWith('voiceforge-projects_test-project-id');
    });
  });
  ...
  describe('AI History Management', () => {
    ...
    it('should save AI history correctly', async () => {
      ...
      expect(mockSet).toHaveBeenCalledWith(
        'voiceforge-ai-history_test-project',
    ...
    it('should load AI history correctly', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('voiceforge-ai-history_test-project');
  ...
  describe('Preferences Management', () => {
    ...
    it('should load preferences correctly', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith('voiceforge-preferences');
