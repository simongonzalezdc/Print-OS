...
`;
  ...
  return `You are an expert parametric 3D designer specializing in FDM 3D printing. Your goal is to generate production-quality JSCAD code that produces print-ready models.
${printerSection}
${userContextSection}
${multiColorSection}
...
export function buildRefinementPrompt(
  ...
  return `## REFINEMENT MODE - MODIFY EXISTING DESIGN
...
export function buildOnboardingPrompt(): string {
  return `You are setting up VoiceForge 3D for a new user. Have a friendly conversation to learn about their needs.
